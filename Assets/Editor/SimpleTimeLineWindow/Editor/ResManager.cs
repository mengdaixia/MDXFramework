    ...
    public class ResManager
    {
        ...
        public static Texture StopIcon
        {
            get
            {
                if (_stopIcon == null)
                {
                    _stopIcon = (EditorGUIUtility.Load("Assets/Editor/EditorResources/StopIcon.png") as Texture);
                }
                return _stopIcon;
            }
        }
        ...
        public static Texture SettingIcon
        {
            get
            {
                ...
                {
                    _settingIcon = (EditorGUIUtility.Load("Assets/Editor/EditorResources/SettingsIcon.png") as Texture);
                }
                return _settingIcon;
            }
        }
        ...
        public static Texture CutOffGuideLineTexture
        {
            get
            {
                if (_cutOffGuideLine == null)
                    _cutOffGuideLine = (EditorGUIUtility.Load("Assets/Editor/EditorResources/CutOffTimeCursor.png") as Texture);
        ...
        public static Texture TimeHeadTexture
        {
            ...
            {
                if (_timeHead == null)
                    _timeHead = (EditorGUIUtility.Load("Assets/Editor/EditorResources/Timecursor.png") as Texture);
                return _timeHead;
            }
        }
    }
