...
namespace DMTimeArea
{
	public abstract class SimpleTimeArea : EditorWindow
	{
		...
		// Time ruler format
		public bool _timeInFrames = true;
		// Edge snap
		...
		protected void PreviousTimeFrame()
		{
		...
		private GUIStyle timeAreaStyle = new GUIStyle("CurveEditorBackground");
		protected virtual void DrawTimeAreaBackGround()
		{
			GUI.Box(_rectTimeAreaContent, GUIContent.none, timeAreaStyle);
			...
			bool showVSlider = false)
		{
			if (_simpleTimeArea == null)
			{
				...
				this._simpleTimeArea.SetShownHRange(-1, 3f);
		...
		protected void DrawTimeRulerArea()
		{
			...
			GUI.color = cl01;
			Rect lineRect = new Rect(timeToPos - _rectTimeAreaRuler.x, TIMELINETIMELABEL_HEIGHT, 1, _rectTimeAreaContent.height - 5);
